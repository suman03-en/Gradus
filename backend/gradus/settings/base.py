...
# Adjusted to go up 3 levels because it's now in gradus/settings/base.py
BASE_DIR = Path(__file__).resolve().parent.parent.parent

# SECURITY WARNING: keep the secret key used in production secret!
# Strictly enforce SECRET_KEY without default in base config.
...
WSGI_APPLICATION = "gradus.wsgi.application"
