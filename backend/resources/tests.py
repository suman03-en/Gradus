...
class ResourcePermissionTests(APITestCase):
    ...
    def test_create_resource_teacher(self):
        ...
        response = self.client.post(
            reverse("resource-list"), self.resource_data, format="multipart"
        )
    ...
    def test_create_resource_student_forbidden(self):
        ...
        self.resource_data["file"] = SimpleUploadedFile(
            "test2.txt", b"content", content_type="text/plain"
        )
        response = self.client.post(
            reverse("resource-list"), self.resource_data, format="multipart"
        )
    ...
    def test_list_resources_teacher(self):
        ...
        response = self.client.get(
            ...
            + f"?content_type=classroom&object_id={self.classroom.id}"
        )
